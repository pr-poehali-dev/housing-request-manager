  ...
  return (
    <div className="min-h-screen bg-background flex flex-col max-w-md mx-auto">
      ...
      <div className="flex-1 px-4 pt-5 pb-28 overflow-y-auto">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">Подайте первую заявку, нажав кнопку ниже</p>
          </div>
        ) : (
              ...
              <Card key={r.id} className="p-4 border-border">
                ...
                {r.master_name && (
                  <div className="flex items-center gap-1.5 mt-2 pt-2 border-t border-border">
                    ...
                    <span className="text-xs text-muted-foreground">Мастер: {r.master_name}</span>
                  </div>
                )}
      ...
      <button
        ...
        className="fixed bottom-6 left-1/2 -translate-x-1/2 w-max px-6 h-14 bg-primary rounded-full shadow-lg shadow-primary/30 flex items-center gap-3 text-primary-foreground font-semibold hover:scale-105 transition-transform z-30"
      >
